...
#plt.ylim([30,50])
plot_mesh(clf2, y, X, title="depth 6")
...
print(leaves)
print('Primer modelo: ',leaves[1]['models'].coef_, '\n Segundo modelo: ',leaves[2]['models'].coef_)
print('Primer modelo: ',leaves[1]['models'].intercept_, '\n Segundo modelo: ',leaves[2]['models'].intercept_)
